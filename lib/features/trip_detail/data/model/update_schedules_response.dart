/// Wraps the `POST /TransRoster/UpdateSchedules` response.
///
/// Observed shape:
/// ```json
/// {
///   "result": [
///     { "errorCode": 0, "dB_Response": "Scheduling saved successfully" }
///   ],
///   "isSuccess": true,
...
class UpdateSchedulesResponse {
  ...
  factory UpdateSchedulesResponse.fromJson(Map<String, dynamic> json) {
